...
export default function Home() {
    const [createProject, setCreateProject] = useState("home");




    if(createProject === "new-project"){
        return <CreateProject setCreateProject={setCreateProject} createProject={createProject} />;
    }else {
        return <>
            <div className={"flex justify-between container text-gray-50"}>
                <div className={"flex-wrap justify-center w-[200px] shadow-xl shadow-gray-950 mt-6"}>
                    <div onClick={()=>{
                        setCreateProject("new-project");
