    ...
    return (
        <g className="sash-component" style={{ pointerEvents: 'none' }}>
            ...
            <rect
                ...
                fill="#7DD3FC" fillOpacity="0.4" stroke="#94A3B8" strokeWidth="0.5"
            />
            ...
            {/* ЛИНИИ ОТКРЫТИЯ */}
            <g fill="none" stroke="#64748b" strokeWidth="1.2" strokeDasharray="6,4" opacity="0.6">
            ...
            <g transform={`translate(${handleX}, ${handleY})`}>
                ...
                <rect x="-15" y="-18" width="30" height="70" rx={2} fill="#F8FAFC" stroke="#475569" strokeWidth="1" />
                <rect x="-10" y="5" width="20" height="100" rx={2} fill="#F8FAFC" stroke="#475569" strokeWidth="1" />
                {/* Сама рукоятка */}
            </g>
        </g>
    );
